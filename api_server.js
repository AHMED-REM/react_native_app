...
expres.post("/newuser", (req, res) => {
    ...
    db.query(sql, [username, password, email, bdate], (err, result) => {
        ...
        console.log("New user added with " + username);
    });
});


// Réponse de l'API au call: get_user avec un username 
expres.get("/user1/:username", (req, res) => {
    db.query(
...
expres.delete("/delete_user/:id", (req, res) => {
    db.query(
